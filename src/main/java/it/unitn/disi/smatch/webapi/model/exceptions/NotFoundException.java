...
/**
 * An exception that is thrown when the HTTP URI is not found
 * 
 * @author Viktor Pravdin <pravdin@disi.unitn.it>
 */
public class NotFoundException extends P2PRequestException {
    ...
    public NotFoundException(String msg) {
        super(msg, HttpURLConnection.HTTP_NOT_FOUND);
    }
}
