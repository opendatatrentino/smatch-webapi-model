...
/**
 * An exception that is thrown when a bad method is called.
 * 
 * @author Viktor Pravdin <pravdin@disi.unitn.it>
 */
public class BadRequestMethodException extends P2PRequestException {

    /**
     * Constructs an instance of <code>NotFoundException</code> with the specified detail message.
     * @param msg the detail message.
     */
    public BadRequestMethodException(String msg) {
        super(msg, HttpURLConnection.HTTP_BAD_METHOD);
    }
}
